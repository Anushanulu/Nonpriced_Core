...
public class Step02_AddResponse_IN
{
	...
	@FindBy (xpath= ".//*[@id='ibm-content-main']/form/div[1]/div[1]/table/tbody/tr[1]/td[2]") private WebElement lbl_Request_No;
	...
	@FindBy ( xpath="//*[@id='ibm-content-main']/form/div[2]/div/table/tbody/tr[7]/td[3]") private WebElement reslink;
	...
	//Add Response and details
	public void FillRespdetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp,String Refernce_Num, String dob, String rate) throws IOException 
	{
		...
		// creating a random no. to enter in GID field to maintain its uniqueness 
		Random rand = new Random(); 
		String Req_No = lbl_Request_No.getText().trim();

		GID.sendKeys(Req_No+rand.nextInt(100000));
