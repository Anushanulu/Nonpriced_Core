...
public class Step04_SBActions_Core_IN {
...
public Step04_SBActions_Core_IN(WebDriver driver)
{
	this.driver=driver;
...
public void loginSB()
{
	...
	Username_Box.clear();
	Username_Box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 11, 0));
	Password_Box.clear();
	Password_Box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 11, 1));
...
public void SB_open_Request ()
{
	...
	wait02.until(ExpectedConditions.visibilityOf(Service_ids));
...
public void SB_Auth_IN ()
{
	...
	/* code to capture screenshot */
	Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).highlight(Resp_identification1).save("C:\\Users\\SriSwathiAnushaNulu\\Documents\\Project csa\\Practice Automation\\NPrice\\Ind");
	...
	/* code to capture screenshot */
	Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).highlight(Auth_Button).save("C:\\Users\\SriSwathiAnushaNulu\\Documents\\Project csa\\Practice Automation\\NPrice\\Ind");
