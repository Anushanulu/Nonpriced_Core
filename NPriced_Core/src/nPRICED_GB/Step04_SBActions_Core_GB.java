...
public class Step04_SBActions_Core_GB {
...
public Step04_SBActions_Core_GB(WebDriver driver)
{
	this.driver=driver;
...
public void loginSB()
{
	...
	Username_Box.clear();
	Username_Box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 7, 0));
	Password_Box.clear();
	Password_Box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 7, 1));
...
public void SB_Auth_req ()
{
	...
	/* code to capture screenshot */
	Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).highlight(Resp_identification1).save("C:\\Users\\SriSwathiAnushaNulu\\Documents\\Project csa\\Practice Automation\\NPrice\\Core\\UK");
	...
	/* code to capture screenshot */
	Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).highlight(Auth_Button).save("C:\\Users\\SriSwathiAnushaNulu\\Documents\\Project csa\\Practice Automation\\NPrice\\Core\\UK");
	...
	Step04_SBActions_Core_GB popup = new Step04_SBActions_Core_GB(driver);
