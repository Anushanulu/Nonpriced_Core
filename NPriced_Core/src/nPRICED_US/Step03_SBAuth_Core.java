...
import lib.Excel;
import nPRICED_GB.Step04_SBActions_Core_GB;
...
public class Step03_SBAuth_Core {
...
public Step03_SBAuth_Core(WebDriver driver)
{
	this.driver=driver;
...
public void SB_Auth_req ()
{
	...
	Step03_SBAuth_Core popup = new Step03_SBAuth_Core(driver);
